...
const {name, status, species, gender, origin, image, onClose, characterId} = props;
...
const handleCloseClick =()=> {
   ...
   return (
      <div className={s.card1} >
         <button className={s.button} onClick={handleCloseClick}><img  className={s.img2} src="img\portal.png" alt="Eliminar" /> </button>
